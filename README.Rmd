...
```{r quick_demo, echo = TRUE, eval = FALSE, results = "hide", warning = FALSE, message = FALSE}
...
```{r path-plot, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=4, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
library(ggplot2)
