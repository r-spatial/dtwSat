...
Land use and land cover changes studies require accurate spatiotemporal data that usually is not available for many regions of the world [@Fritz:2013]. This has lead to much recent development of automated and semiautomated methods for use and land cover classification, *e.g* land cover mapping [@Griffiths:2013], detecting forest disturbance and recovery [@Kennedy:2010; @Zhu:2012; @DeVries:2015], crop classification [@Xiao:2005; @Wardlow:2007; @Petitjean:2012; @Maus:2016], planted forest mapping [@Maire:2014], and crop expansion and intensification [Galford:2008; Sakamoto:2009]. Particularly, the Time-Weighted Dynamic Time Warping (TWDTW) by [@Maus:2016] is flexible to account for multiyear crops, single cropping and double cropping. It is also robust to account for other land cover types such as forest and pasture and works with a small amount of training samples. 
