...
doy = brick(flist[2])
raster_list = createRasterTimeSeries(x = brick_list, timeline = timeline[,1], doy = doy)
```
...
```{r template, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=2, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
...
```{r plot-alig, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=8, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
