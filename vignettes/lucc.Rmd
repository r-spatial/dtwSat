...
The Time-Weighted Dynamic Time Warping (TWDTW) is adapted to multi-band satellite image time series analysis, and it is flexible to compare satellite time series even if they are irregularly sampled, or are out of phase in the time axis (cf. Maus et al. [-@Maus:2016] for details).

[@Velichko:1970] [@Sakoe:1971] [@Sakoe:1978] [@Rabiner:1993] [@Berndt:1994] [@Muller:2007]
...
```{r plot-studyarea, echo = FALSE, eval = FALSE, fig.path='figure/', fig.width=6, fig.height=4, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
plot(raster("./inst/lucc_MT/study_area.jpg"))
```
...
```{r temporal-patterns, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=4, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
library(ggplot2)
...
```{r plot-map, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=4, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
...
```{r plot-area, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=4, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
...
```{r plot-change, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=4, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
