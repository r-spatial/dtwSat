...
```{r temporal_patterns, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=4, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
library(ggplot2)
...
```{r plot_alig, echo = TRUE, eval = TRUE, fig.path='figure/', fig.width=6, fig.height=8, fig.align='center', fig.cap='Typical temporal patterns.', warning = FALSE, message = FALSE}
