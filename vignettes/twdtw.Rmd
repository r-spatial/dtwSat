...
vignette: >
  %\VignetteIndexEntry{Time-Weighted Dynamic Time Warping}
...
Time-Weighted Dynamic Time Warping is a variation of the well-known Dynamic Time Warping (DTW) algorithm that includes a time-weight as constraint to perform a time series alignment. It works by comparing unclassified satellite image time series with a set of known temporal patterns (e.g. phenological cycles of vegetation types). This is particularly useful when the temporal pattern is much shorter than the unclassified time series, and to classify time series with strong time dependency, such as phenological the stages of vegetation. 
