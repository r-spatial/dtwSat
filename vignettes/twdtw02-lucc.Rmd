---
title: "2. Land-cover cahnge analysis with TWDTW"
author: "Victor Maus"
output:
  html_document:
    toc: true
    ...
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{1. Land-cover cahnge analysis with TWDTW}
...
Note the argument `minimalist = TRUE`. Setting this argument to `TRUE` considerably improves the performance of the processing for two reasons. First it  does not keep any intermediate dataset, second it implements a change in the TWDTW algorithm to reduce processing.
